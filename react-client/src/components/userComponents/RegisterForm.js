...
//       });
//     }
//   }, [registerLoading, registerError, user, navigate, toast]); const handleSubmit = async (e: React.FormEvent) => {
...
//     }
//     if (!agreed) {
//       fieldErrors.agreed = 'You must agree to the terms and conditions';
//     }
    ...
    const fields = [
        {
            ...
            icon: _jsx(User, { className: "h-5 w-5" }),
            value: fullName,
