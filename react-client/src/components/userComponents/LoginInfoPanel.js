...
const LoginInfoPanel = () => {
    ...
    return (_jsxs("div", { className: "hidden md:flex flex-col bg-gradient-to-br from-emerald-100 via-green-100 to-teal-200 p-10 lg:p-16 items-center justify-center text-gray-800 h-full overflow-hidden relative", children: [_jsx(motion.div, { className: "absolute -top-20 -left-20 w-72 h-72 bg-emerald-400/20 rounded-full filter blur-3xl", animate: { scale: [1, 1.1, 1], rotate: [0, 10, 0] }, transition: { duration: 20, repeat: Infinity, ease: "linear" } }), _jsx(motion.div, { className: "absolute -bottom-20 -right-20 w-80 h-80 bg-green-400/15 rounded-full filter blur-3xl", animate: { scale: [1, 1.2, 1], rotate: [0, -15, 0] }, transition: { duration: 25, repeat: Infinity, ease: "linear", delay: 5 } }), _jsxs(motion.div, { className: "max-w-lg w-full z-10", variants: panelVariants, initial: "hidden", animate: "visible", children: [_jsxs(motion.div, { variants: itemVariants, className: "mb-12 text-center", children: [_jsxs("div", { className: "flex items-center justify-center gap-3 mb-4", children: [_jsx(Sparkles, { className: "w-10 h-10 text-emerald-600" }), _jsx("h1", { className: "text-5xl font-bold tracking-tight text-gray-800", children: "CryptoGuard" })] }), _jsx("p", { className: "text-xl text-gray-700 leading-relaxed font-light", children: "Next-Generation Platform for Uncompromising File Security & Management." })] }), _jsx(motion.div, { className: "space-y-8 mb-12", variants: itemVariants, children: features.map((feature, index) => (_jsxs(motion.div, { className: "flex items-start space-x-5 group", variants: itemVariants, children: [_jsx("div", { className: "flex-shrink-0 w-14 h-14 bg-gradient-to-br from-emerald-300/30 to-green-300/25 rounded-xl flex items-center justify-center group-hover:from-emerald-400/40 group-hover:to-green-400/35 transition-all duration-300 border border-emerald-300/30 shadow-lg group-hover:shadow-emerald-300/20", children: _jsx(feature.icon, { className: "w-7 h-7 text-emerald-700 group-hover:scale-110 transition-transform duration-300" }) }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-gray-800 mb-1.5 text-lg tracking-tight", children: feature.title }), _jsx("p", { className: "text-gray-700 text-sm leading-relaxed font-light", children: feature.description })] })] }, index))) }), _jsx(motion.div, { className: "space-y-6 mb-12", variants: itemVariants, children: testimonials.map((testimonial, index) => (_jsxs(motion.div, { className: "bg-white/40 rounded-xl p-6 backdrop-blur-md border border-emerald-200/50 shadow-xl hover:border-emerald-300/60 transition-all duration-300", variants: itemVariants, children: [_jsx("div", { className: "flex items-center mb-3", children: [...Array(5)].map((_, i) => (_jsx(Star, { className: "w-5 h-5 text-yellow-500 fill-current" }, i))) }), _jsxs("p", { className: "text-gray-800 text-base mb-3 italic leading-relaxed", children: ["\"", testimonial.text, "\""] }), _jsxs("div", { className: "text-xs text-gray-600 text-right", children: [_jsx("span", { className: "font-medium block", children: testimonial.author }), _jsx("span", { className: "font-light", children: testimonial.role })] })] }, index))) }), _jsx(motion.div, { variants: itemVariants, className: "pt-10 border-t border-emerald-300/30", children: _jsxs("div", { className: "flex items-center justify-around text-sm", children: [_jsxs("div", { className: "flex items-center space-x-2.5", children: [_jsx(CheckCircle, { className: "w-5 h-5 text-emerald-600" }), _jsx("span", { className: "text-gray-700 font-medium", children: "AES-256 Bit Encryption" })] }), _jsxs("div", { className: "flex items-center space-x-2.5", children: [_jsx(Shield, { className: "w-5 h-5 text-emerald-600" }), _jsx("span", { className: "text-gray-700 font-medium", children: "ISO 27001 Compliant" })] })] }) })] })] }));
};
export default LoginInfoPanel;
